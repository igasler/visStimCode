 function RetinotAlternateBW_NN_grayGaps_14_02_17_neuroligin
...
for j=1:n_reps
    for s=1:prod(n_patches)*2;
        ...
        while ~getvalue(dio.Line(1)),
            if KbCheck
                Screen('Close');
                clear mex; clear imgstack; clear imgtex masktex BW
...
clear Warte angle ans clutCounter clut_cycles ext_patch_nr eye i i2 j la lo ...
    ...
    srcRect stim_ids window x xx y yy BW masktex
save([starttimestr 'HRret']);
ShowCursor;
